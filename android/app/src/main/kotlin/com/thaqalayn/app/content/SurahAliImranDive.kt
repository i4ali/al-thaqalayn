...
// Fixed content for the "Inside the Surah - Al Imran" experience - the chosen,
// purified house of Imran (Maryam, 3:33-61) and the Mubahala that answers it.
// Verbatim port of iOS Content/SurahAliImranDive.swift; rendered by
// DeepDiveScreen. English-only for now: every LocalizedText is a bare English
// string (ur/ar fall back to English). Qur'an Arabic is verbatim from
// quran_data.json.
...
val surahAliImranDive: DeepDive = DeepDive(
    id = "surah-ali-imran",
    titleEn = "Al Imran",
    titleAr = "آلِ عِمْرَان",
    subtitle = LocalizedText("The Family of Imran - how God carries His truth through the households He chooses and purifies"),
    estMinutes = 11,
    acts = listOf(
        ActInfo(1, "آلُ عِمْرَان", "Al Imran", LocalizedText("The Chosen House")),
        ActInfo(2, "الْمُبَاهَلَة", "al-Mubahala", LocalizedText("The Ordeal"))
    ),
    sections = listOf(
        DeepDiveSection.Open(
            ...
            titleAr = "آلِ عِمْرَان",
            titleEn = "Al Imran",
            subtitle = LocalizedText("The Family of Imran"),
            line = LocalizedText("God named only a few of His surahs after a family, and this is the longest of them. It opens the door of a house He chose before its children were born, purified with His own hand, and fed with fruit out of season. And it does not end there. When the truth itself was one day put on trial, this surah answered with the faces of another house entirely. Come inside.")
        ),
        DeepDiveSection.Orientation(
            ...
            leaveWith = LocalizedText("You will leave knowing this surah’s quiet secret: that the surest proof God ever offered of His own truth was not an army and not a wonder, but a small circle of faces He had chosen and purified - and you will know exactly whose they were.")
        ),
        DeepDiveSection.Act(
            act = 1,
            connector = null,
        ...
        DeepDiveSection.Verse(
            ...
            translation = LocalizedText("When the wife of Imran said, “My Lord, I have vowed to You what is in my womb, dedicated to Your service. So accept it from me. Indeed You are the Hearing, the Knowing.”"),
            reference = "Al Imran · 3 : 35",
            reflection = LocalizedText("The chosen house does not begin with a child. It begins with a mother’s surrender. Imran’s wife - the traditions call her Hannah - vows the baby in her womb to God’s service before she knows its face, before she even knows if it is the son she was promised. Al-Mizan notes that such children were dedicated to serve at the Temple, and that this was expected to be a boy. She does not bargain, and she does not wait to see what she is getting. She hands over the first and the best, sight unseen. This is how a house becomes worthy of being chosen: someone inside it gives God everything before God has shown His hand.")
        ),
        DeepDiveSection.Verse(
            act = 1,
            tag = LocalizedText("Fruit Out of Season"),
            surah = 3, ayah = 37,
            ...
            translation = LocalizedText("So her Lord accepted her with a beautiful acceptance, and made her grow in a beautiful way, and placed her in the care of Zakariyya. Whenever Zakariyya entered upon her in the prayer-niche, he found provision with her. He said, “O Maryam, from where is this to you?” She said, “It is from God. Indeed God provides for whom He wills without measure.”"),
            reference = "Al Imran · 3 : 37",
            reflection = LocalizedText("A girl is born where a boy was awaited, and God accepts her “with a beautiful acceptance” - the expectation had been human; the choosing was His. She grows up inside the mihrab, the prayer-niche, and Zakariyya (alayhi al-salam) keeps finding food beside her that no hand had carried in - summer fruit in the dead of winter, the commentators say. “From where is this to you?” “It is from God, who provides without measure.” Her mother had begged God’s refuge for her and her offspring from Satan, and the Prophet ﷺ said that Maryam and her son were the only two ever born whom Satan could not touch. Imam al-Baqir (alayhi al-salam) said the angels themselves spoke with her. This is what a purified soul looks like from the outside: fed by a hand no one else can see.")
        ),
        DeepDiveSection.Verse(
            act = 1,
            tag = LocalizedText("Chosen and Purified"),
            surah = 3, ayah = 42,
            ...
            translation = LocalizedText("And when the angels said, “O Maryam, God has chosen you and purified you, and chosen you above the women of the worlds.”"),
        ...
        DeepDiveSection.Narration(
            act = 1,
            tag = LocalizedText("The Four"),
            source = LocalizedText("The Prophet Muhammad ﷺ · Musnad Ahmad"),
            body = LocalizedText("When the angels named Maryam the best of the women of the worlds, they left a question hanging in the air: who else stands in that rank? The Prophet ﷺ answered it, by name. “The best of the women of all the worlds are four,” he said: “Maryam bint Imran, Asiya bint Muzahim the wife of Pharaoh, Khadija bint Khuwaylid, and Fatima bint Muhammad.” It is a narration kept in the books of Shia and Sunni alike."),
            reflection = LocalizedText("Hold the four names together and a bridge appears across six hundred years. Among the four greatest women God ever raised, the Prophet ﷺ named his own daughter, Fatima (alayha al-salam), in the same breath as Maryam. Remember her name. Before the surah closes, it is going to need it.")
        ),
        DeepDiveSection.Act(
            act = 2,
            connector = LocalizedText("You have watched God choose a house and purify a daughter within it, and name her among the four best women ever to live."),
        ...
        DeepDiveSection.Verse(
            act = 2,
            tag = LocalizedText("A Word from Him"),
            surah = 3, ayah = 45,
        ...
        DeepDiveSection.Climax(
            ...
            translation = LocalizedText("So whoever disputes with you about him after the knowledge that has come to you, say: “Come, let us call our sons and your sons, our women and your women, ourselves and yourselves; then let us pray earnestly, and place the curse of God upon the liars.”"),
        ...
        DeepDiveSection.Closing(
            ...
            titleAr = "آلِ عِمْرَان",
            essence = LocalizedText("God chooses households and makes them pure, so that His truth would never stand in the world without a family to carry it."),
            line = LocalizedText("You have seen the pattern drawn twice now - the house of Imran, and the house of Muhammad ﷺ. Read the surah now in its own words, unhurried, and watch the same hand that fed Maryam (alayha al-salam) in her niche reach all the way to the cloak.")
        )
    )
)
