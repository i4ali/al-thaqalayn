...
// Fixed content for the "Inside the Surah - al-Nahl" experience. Verbatim port of
// iOS Content/SurahNahlDive.swift; rendered by DeepDiveScreen.
...
val surahNahlDive: DeepDive = DeepDive(
    id = "surah-nahl",
    titleEn = "al-Nahl",
    titleAr = "النَّحْل",
    ...
    estMinutes = 15,
    acts = listOf(
        ActInfo(1, "النِّعَم", "al-Ni'am", LocalizedText("The Pouring")),
        ActInfo(2, "الْجُحُود", "al-Juhud", LocalizedText("The Denial")),
        ActInfo(3, "النَّحْل", "al-Nahl", LocalizedText("The Bee")),
        ActInfo(4, "الْبَاقِي", "al-Baqi", LocalizedText("What Remains"))
    ),
    sections = listOf(
        ...
        DeepDiveSection.Verse(
            ...
            translation = LocalizedText("And indeed, in the grazing herds there is a lesson for you: We give you drink from what is in their bellies - from between waste and blood - pure milk, easy for those who drink."),
        ...
        DeepDiveSection.Act(
            ...
            bridge = BridgeVerse(
                ...
                translation = LocalizedText("What is with you runs out; and what is with Allah remains. And We will surely pay those who were patient their wage by the best of what they used to do."),
                reference = "al-Nahl · 16 : 96"
            )
        ),
        DeepDiveSection.Verse(
            act = 4,
            tag = LocalizedText("What Cannot Be Confiscated"),
            surah = 16, ayah = 106,
        ...
        DeepDiveSection.Closing(
            tag = LocalizedText("Before You Go"),
            titleAr = "النَّحْل",
